...
namespace offsets
{
	namespace client
	{
		inline std::ptrdiff_t dwCSGOInput = 0x2319FC0;
		inline std::ptrdiff_t dwEntityList = 0x24AF268;
		inline std::ptrdiff_t dwGameEntitySystem = 0x24AF268;
		inline std::ptrdiff_t dwGameEntitySystem_highestEntityIndex = 0x20A0;
		inline std::ptrdiff_t dwGameRules = 0x230DEE0;
		inline std::ptrdiff_t dwGlobalVars = 0x205E5C0;
		inline std::ptrdiff_t dwGlowManager = 0x230ACE8;
		inline std::ptrdiff_t dwLocalPlayerController = 0x22F4188;
		inline std::ptrdiff_t dwLocalPlayerPawn = 0x2069B50;
		inline std::ptrdiff_t dwPlantedC4 = 0x2317740;
		inline std::ptrdiff_t dwPrediction = 0x2069A60;
		inline std::ptrdiff_t dwSensitivity = 0x230B7F8;
		inline std::ptrdiff_t dwSensitivity_sensitivity = 0x58;
		inline std::ptrdiff_t dwViewAngles = 0x231A648;
		inline std::ptrdiff_t dwViewMatrix = 0x230FF20;
		inline std::ptrdiff_t dwViewRender = 0x2310338;
		inline std::ptrdiff_t dwWeaponC4 = 0x2298F00;
	}
